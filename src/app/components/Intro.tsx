...
const Intro = ({ visibility }: { visibility: boolean }) => {
  return (
    <section
      className={`container m-auto px-4 py-10 ${
          ...
          <div className="store-info">
            ...
            <div className="store-body">
              ...
              <div className="flex mb-3 items-center">
                ...
                <div className="info-text text-sm flex-1">Near Saket Mall</div>
              </div>
              <div className="flex mb-3 items-center">
                <div className="info-icon w-8 text-2xl text-primary">
                  <MdAddCall />
